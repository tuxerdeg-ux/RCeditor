...
ULONG PrefsDialog(void)
{
    Object        *dlg_obj;
    struct Window *dlg_win;
    struct Gadget *case_zeilenn;
    ULONG          dlg_signal, dlg_result;
    ULONG          retLine = 0;
    BOOL           dlg_done = FALSE;
    char           initBuf[32];

    enum { DLG_MAIN=0, DLG_OK=1, DLG_SAVE=2, DLG_CANCEL=3,DLG_ZeilenN=4 };



    dlg_obj = WindowObject,
        WA_Title,       "Einstellungen",
        WA_Width,       280,
        WA_Height,      80,
        WA_DragBar,     TRUE,
        WA_CloseGadget, TRUE,
        ...
        WINDOW_ParentGroup, VGroupObject,
            ...
            LAYOUT_AddChild, HGroupObject,
                LAYOUT_AddChild, case_zeilenn = CheckBoxObject,
                    GA_ID,        DLG_ZeilenN,
                    GA_Text,      "_Zeilennummern an/aus",
                    GA_Selected,  FALSE,
                    GA_TabCycle,  TRUE,
                End,
            End,
